<%@ page contentType="text/html;charset=UTF-8" %>
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        ...
        <head>
            ...
            <title>Change password | Artifact Alley</title>
        ...
        <body>
            <nav class="navbar navbar-dark auction-nav">
                <div class="container"><a class="navbar-brand" href="/">Artifact Alley</a><span
                        class="navbar-text">Account settings</span></div>
            </nav>
                ...
                <div class="auth-card mx-auto p-4 p-md-5">
                    ...
                    <form:form method="post" modelAttribute="changePasswordForm" class="mt-4" novalidate="true">
                        ...
                        <div class="mb-3">
                            ...
                            <form:password path="currentPassword" cssClass="form-control" maxlength="72"
                                autocomplete="current-password" />
                            <form:errors path="currentPassword" cssClass="invalid-feedback d-block" />
                        </div>
                        <div class="mb-3">
                            <form:label path="newPassword" cssClass="form-label">New password</form:label>
                            <form:password path="newPassword" cssClass="form-control" maxlength="72"
                        ...
                        <div class="mb-4">
                            ...
                            <form:password path="confirmPassword" cssClass="form-control" maxlength="72"
                                autocomplete="new-password" />
